...
# KEY_FILE = "zen-private.key"                       # This is a private key file that is used to encrypt and decrypt the text.

# #* Saves the key to a new key file with the default name: `zen-private.key`
